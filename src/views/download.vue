  ...
  <div class="download">
    ...
    <div class="download-message">
      <div class="download-nav">
        <router-link class="download-nav-btn" to="/download/teacher"
          >老师端</router-link
        >
        <router-link class="download-nav-btn" to="/download/parents"
          >家长端</router-link
        >
      </div>
      ...
      <div class="download-content">
        <div class="download-btn-box">
          <div
            ...
            @click="handleSwitchPlatform('ios')"
          >
          ...
          <div
            ...
            @click="handleSwitchPlatform('android')"
          >
