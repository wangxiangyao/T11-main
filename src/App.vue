<template>
  <div id="app">
    ...
    <div class="state" v-if="isShowBanner">
      ...
      <div class="title-box">
        <div class="title" v-if="mode == 1">
          <div class="main-title">尊师重道<i class="title-space"></i>深水静流</div>
          <div class="sub-title">Respecting Teachers and Respecting Highways</div>
        </div>
    ...
    <keep-alive>
      <router-view v-if="$route.name == 'home'" class="main-content"></router-view>
    </keep-alive>
