...
<style scoped>
  ...
  .articleBreviary .right .normal,  .articleBreviary:hover .right .active{
    display: flex;
    flex-direction: column;
    justify-content: center;
    height: 100%;
  ...
  .articleBreviary .right .caption-box, .articleBreviary .right .more {
    margin-left: 100px;
    margin-right: 20px;
  }
  ...
  .articleBreviary .left .sort, .articleBreviary .left .date {
    transition: opacity 1s;
    opacity: 1;
  }
  .articleBreviary:hover .left .sort, .articleBreviary:hover .left .date {
    transition: opacity 1s;
    opacity: 0;
  }
